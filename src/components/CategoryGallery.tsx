...
const CategoryGallery: React.FC = () => {
  ...
  // Filter videos based on search term and active tags
  const filteredVideos = videos.filter((video) => {
    // Check if video has tags and matches the active tag filters
    ...
    <div className="p-4 sm:p-6 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          <h1 className="text-3xl font-bold capitalize mb-4 sm:mb-0">{category} Videos</h1>
